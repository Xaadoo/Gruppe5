...
// Nye medlemmer legges til  under her. Skal vi legge formen til en egen fil?
//________________________________________________________________________________________________________________
...
class AddEvent extends React.Component<{}> {
  refs: {
    ...
    submitEvent: HTMLInputElement
  };
  render() {
    return <div>
      <h1>Opprett arrangement</h1><br />
      <form ref="submitEvent">
        Navn: <input type="text" ref="addEventName" required/>
        Postnummer: <input type="text" ref="addZipCode" required/>
        Startdato: <input type="date" ref="addEventStartDate" required/>
        Slutdato: <input type="date" ref="addEventEndDate" required/><br />
        Beskrivelse: <textarea cols="40" rows="5" ref='addEventDescription' required/><br /><br />
        Starttidspunkt: <input type="time" ref="addStartTime" required/>
        Sluttidspunkt: <input type="time" ref="addEndTime" required/><br /><br />
        Oppmøtedato: <input type="date" ref="addMeetingDate" required/>
        Oppmøtested: <input type="text" ref="addMeetingPoint" required/>
        Oppmøtetidspunkt: <input type="time" ref="addMeetingTime" required/><br />
        Kontaktperson: <input type="number" ref="addContactPerson" required/>
        Vaktmal:<br />
        Utstyrsliste: <br /><br />

        <input type="submit" ref="addEventButton" value="Opprett arrangement"/>
      </form>
      </div>
  }
  ...
  componentDidMount() {
    eventList = this;
    this.refs.submitEvent.onsubmit = () => {
